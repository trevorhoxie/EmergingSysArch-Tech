...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_off(self):
        redLight.off()
        blueLight.off() #turn off both LEDs to indicate 'off' state
    ...
    def processTempStateButton(self):
        ...
        self.cycle() #cycle to next state
    ...
    def updateLights(self):
        ...
        if self.current_state.id == "heat":
            if temp < self.setPoint:
                redLight.pulse() # fade LED in and out
...
greenButton.when_pressed = tsm.processTempStateButton # Change state of thermostat to heat, cool, or off when green button pressed
...
##
redButton = Button(25)
redButton.when_pressed = tsm.processTempIncButton # Increment temperature when red button is pressed
...
blueButton.when_pressed = tsm.processTempDecButton # Decrement temperature when blue button is pressed
